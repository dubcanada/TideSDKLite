...
describe("API Tests", {
  ...
  test_logging_methods: function () {
    value_of(Titanium.API.critical)
      .should_be_function();
    value_of(Titanium.API.debug)
      .should_be_function();
    value_of(Titanium.API.error)
      .should_be_function();
    value_of(Titanium.API.fatal)
      .should_be_function();
    value_of(Titanium.API.notice)
      .should_be_function();
    value_of(Titanium.API.trace)
      .should_be_function();
    value_of(Titanium.API.warn)
      .should_be_function();

    //new 1.0
    value_of(Titanium.API.setLogLevel)
      .should_be_function();
  ...
  validate_properties: function () {
    value_of(Titanium.API.APP_UPDATE)
      .should_not_be_null();
    value_of(Titanium.API.CRITICAL)
      .should_not_be_null();
    value_of(Titanium.API.DEBUG)
      .should_not_be_null();
    value_of(Titanium.API.EQ)
      .should_not_be_null();
    value_of(Titanium.API.ERROR)
      .should_not_be_null();
    value_of(Titanium.API.FATAL)
      .should_not_be_null();
    value_of(Titanium.API.GT)
      .should_not_be_null();
    value_of(Titanium.API.GTE)
      .should_not_be_null();
    value_of(Titanium.API.INFO)
      .should_not_be_null();
    value_of(Titanium.API.LT)
      .should_not_be_null();
    value_of(Titanium.API.LTE)
      .should_not_be_null();
    value_of(Titanium.API.MOBILESDK)
      .should_not_be_null();
    value_of(Titanium.API.NOTICE)
      .should_not_be_null();
    value_of(Titanium.API.RUNTIME)
      .should_not_be_null();
    value_of(Titanium.API.SDK)
      .should_not_be_null();
    value_of(Titanium.API.TRACE)
      .should_not_be_null();
    value_of(Titanium.API.UNKNOWN)
      .should_not_be_null();
    value_of(Titanium.API.WARN)
      .should_not_be_null();

    value_of(Titanium.API.createDependency)
      .should_be_function();
    value_of(Titanium.API.critical)
      .should_be_function();
    value_of(Titanium.API.debug)
    ...
    value_of(Titanium.API.fatal)
      .should_be_function();
    value_of(Titanium.API.fireEvent)
      .should_be_function();
    value_of(Titanium.API.get)
      .should_be_function();
    value_of(Titanium.API.getApplication)
      .should_be_function(); //done
    value_of(Titanium.API.getComponentSearchPaths)
      .should_be_function();
    value_of(Titanium.API.getInstalledComponents)
      .should_be_function();
    value_of(Titanium.API.getInstalledMobileSDKs)
      .should_be_function();
    value_of(Titanium.API.getInstalledModules)
      .should_be_function();
    value_of(Titanium.API.getInstalledRuntimes)
      .should_be_function();
    value_of(Titanium.API.getInstalledSDKs)
      .should_be_function();
    value_of(Titanium.API.info)
      .should_be_function();
    value_of(Titanium.API.installDependencies)
      .should_be_function();
    value_of(Titanium.API.log)
      .should_be_function();
    value_of(Titanium.API.notice)
      .should_be_function();
    value_of(Titanium.API.readApplicationManifest)
      .should_be_function();
    value_of(Titanium.API.addEventListener)
      .should_be_function();
    value_of(Titanium.API.set)
      .should_be_function();
    value_of(Titanium.API.trace)
      .should_be_function();
    value_of(Titanium.API.removeEventListener)
      .should_be_function();
    value_of(Titanium.API.warn)
      .should_be_function();
  ...
  test_components: function () {
    ...
    if (apiInstalledComponents1.length) {
      ...
      for (i = 0; i < apiInstalledComponents1.length; i++) {
        ...
        value_of(item)
          .should_be_object();
        Titanium.API.info("apiInstalledComponents[" + i + "]= name: '" + item.getName() + "' type: '" + item.getType() + "' version: '" + item.getVersion() + "' path '" + item.getPath() + "'");
      }
    } else {
  ...
  test_dependancies: function () {
    ...
    Titanium.API.info("processing dependancy '" + dep.getName() + "' type: '" + dep.getType() + "' version: '" + dep.getVersion() + "'");
  },
  ...
  test_installed_runtime: function () {
    ...
    if (apiInstalledRuntimes1.length) {
      ...
      for (i = 0; i < apiInstalledRuntimes1.length; i++) {
        ...
        Titanium.API.info("apiInstalledRuntimes[" + i + "] name: '" + item.getName() + "' type: '" + item.getType() + "' version: '" + item.getVersion() + "' path '" + item.getPath() + "'");
      }
    } else {
  ...
  test_installed_modules: function () {
    ...
    if (apiInstalledModules1.length) {
      ...
      for (i = 0; i < apiInstalledModules1.length; i++) {
        ...
        Titanium.API.info("apiInstalledModules[" + i + "] name: '" + item.getName() + "' type: '" + item.getType() + "' version: '" + item.getVersion() + "' path '" + item.getPath() + "'");
      }
    } else {
  ...
  test_api_sdk: function () {
    ...
    if (sdks.length) {
      ...
      for (i = 0; i < sdks.length; i++) {
        ...
        Titanium.API.info("apiInstalledSDKs[" + i + "] name: '" + item.getName() + "' type: '" + item.getType() + "' version: '" + item.getVersion() + "' path '" + item.getPath() + "'");
      }
    } else {
    ...
    if (app) {
      ...
      for (j = 0; j < sdks.length; j++) {
        var module = sdks[j];
        Titanium.API.info("processing SDK component '" + module.getName() + "' type: '" + module.getType() + "' version: '" + module.getVersion() + "' path '" + module.getPath() + "'");
        ...
        for (i = 0; i < components.length; i++) {
          ...
          Titanium.API.info("processing component '" + am.getName() + "' type: '" + am.getType() + "' version: '" + am.getVersion() + "' path '" + am.getPath() + "'");
  ...
  test_api_installed_mobile_sdks: function () {
    ...
    for (j = 0; j < mobileSDKs.length; j++) {
      ...
      Titanium.API.info("processing mobile SDK module '" + module.getName() + "' type: '" + module.getType() + "' version: '" + module.getVersion() + "' path '" + module.getPath() + "'");
